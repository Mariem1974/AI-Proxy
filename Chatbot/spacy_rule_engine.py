...
#     def __init__(self):
#         # Lightweight model is enough (rules only)
#         self.nlp = spacy.blank("en")
#         self.matcher = Matcher(self.nlp.vocab)

#         self._init_prompt_injection_rules()
#         self._init_malicious_code_rules()
...
#             [{"LOWER": "ignore"}, {"LOWER": {"IN": ["previous", "all"]}}, {"LOWER": "instructions"}],

#             # You are no longer X
#             [{"LOWER": "you"}, {"LOWER": "are"}, {"LOWER": "no"}, {"LOWER": "longer"}],

#             # Act as / pretend to be
#             [{"LOWER": {"IN": ["act", "pretend"]}}, {"LOWER": "as"}],

#             # System prompt extraction
#             [{"LOWER": "reveal"}, {"LOWER": {"IN": ["system", "developer"]}}, {"LOWER": "prompt"}],

#             # Jailbreak wording
#             [{"LOWER": "bypass"}, {"LOWER": {"IN": ["safety", "security", "filters"]}}],

#             [{"LOWER": "disregard"}, {"LOWER": "rules"}],
#         ]

#         self.matcher.add("PROMPT_INJECTION", injection_patterns)

#     # =========================
#     # Malicious Code Rules
#     # =========================
#     def _init_malicious_code_rules(self):
#         sql_patterns = [
#             # SELECT * FROM table
#             [
#                 {"LOWER": "select"},
...
#     # =========================
#     # Regex Patterns (PII, Secrets, Encodings)
#     # =========================
#     def _init_regex_patterns(self):
#         self.regex_patterns.update({

#             # SQL Injection (raw payloads)
#             "SQLI": re.compile(
#                 r"(?i)\b(select|union|insert|delete|drop|update|alter)\b"
#                 r".*?\b(from|where|table)\b"
#             ),
...
#                 findings["regex_hits"].append({
#                     "type": name,
#                     "text": match.group()
#                 })

#         findings["malicious"] = bool(findings["matcher_hits"] or findings["regex_hits"])
#         return findings
